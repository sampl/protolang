...
export default () => {
  return (
    <OneCol>
      ...
      <p>
        Here's a quick, non-legally-binding summary:
      </p>
      <ul>
        <li>
        ...
        <li>
          Your membership is subject to our{" "}
          <Link to="/conduct">code of conduct</Link>
        </li>
        <li>
          Your data privacy is determined by our{" "}
          <Link to="/privacy">privacy policy</Link>
        </li>
        <li>
          If you contribute content to Protolang, you agree to license your work
          under the <Link to="/open-source">relevant open source license</Link>
        </li>
        <li>
          We may email you, but you can always unsubscribe
        </li>
        <li>
          If you have questions or need help, email us at <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>
        </li>
      </ul>
      ...
      <p>
        ...
        located at <a href="https://protolang.com/">https://protolang.com/</a>{" "}
        operated by <strong>Directed Works LLC</strong> (“
      ...
      <p>
        ...
        <a href="https://protolang.com/privacy">
          https://protolang.com/privacy
        </a>
        .
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:sam@directedworks.com">sam@directedworks.com</a> so we
        can try to find a solution. These Terms apply to all visitors, users and
      ...
      <p>
        ...
        communications from us at any time by following the unsubscribe link or
        contacting{" "}
        <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>.
      </p>
      ...
      <p>
        If you have any questions about your purchases or managing your billing
        account, you can get help at any time by emailing us at{" "}
        <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>.
      </p>
      ...
      <p>
        ...
        recurring and periodic basis (“<strong>Billing Cycle</strong>”). Billing
      ...
      <p>
        You will be billed each cycle according to the original date of your
        purchase, and you will receive an emailed invoice after your payment is
        charged.
      </p>
      <p>
        At the end of each Billing Cycle, your Subscription will automatically
        renew under the exact same conditions unless you cancel it or Directed
        Works LLC cancels it. You may cancel your Subscription renewal either
        through your online account management page or by contacting the our
        customer support team at{" "}
        <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>.
      </p>
      <p>
        A valid payment method, including a credit card, is required to process
        the payment for your subscription. You shall provide Directed Works LLC
        ...
        authorize Directed Works LLC to charge all Subscription fees incurred
        through your account to any such payment instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, Directed Works
      ...
      <h2>Free Trial</h2>
      <p>
        Directed Works LLC may, at its sole discretion, offer a Subscription
      ...
      <p>
        ...
        you will not be charged by Directed Works LLC until Free Trial has
      ...
      <p>
        At any time and without notice, Directed Works LLC reserves the right to
      ...
      <h2>Fee Changes</h2>
      <p>
        Directed Works LLC, in its sole discretion and at any time, may modify
      ...
      <p>
        Directed Works LLC will provide you with a reasonable prior notice of
        any change in Subscription fees to give you an opportunity to terminate
      ...
      <h2>Refunds</h2>
      <p>
        We issue refunds for Purchases within thirty (30) days of the original
        Purchase.
      </p>
      <p>
        If you need help with a refund, you can contact us via email at{" "}
        <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>
      </p>
      ...
      <p>
        ...
        (“<strong>Content</strong>”). You are responsible for Content that you
      ...
      <p>
        ...
        of Service, who may also use your Content subject to these Terms. You recognize that any content you submit in Protolang will be visible
        to anyone.
      </p>
      <p>
        Directed Works LLC has the right but not the obligation to monitor and
      ...
      <p>Supabase is a backend platform-as-a-service.</p>
      <p>
        For more information on what type of information Supabase collects,
        please visit the Supabase Terms web page:
      ...
      <p>
        ...
        and password if you have set one, including but not limited to the restriction of access to
      ...
      <p>
        ...
        Directed Works LLC and its licensors. Service is protected by copyright,
        ...
        the prior written consent of Directed Works LLC.
      </p>
      ...
      <p>
        ...
        to <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>,
      ...
      <p>
        ...
        <strong>Feedback</strong>”). You acknowledge and agree that: (i) you
      ...
      <p>
        ...
        are not owned or controlled by Directed Works LLC.
      </p>
      <p>
        Directed Works LLC has no control over, and assumes no responsibility
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT DIRECTED WORKS LLC SHALL NOT BE
      ...
      <p>
        ...
        Service. Upon termination, if you wish to receive a refund on the most
        recent billing cycle for your account, you can email{" "}
        <a href="mailto:sam@directedworks.com">sam@directedworks.com</a>.
      </p>
      <p>
      ...
      <p>
        <em>This document was last updated on March 2, 2023</em>
      </p>
    </OneCol>
  );
};
